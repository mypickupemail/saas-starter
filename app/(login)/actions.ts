...
export const deleteAccount = validatedActionWithUser(
  ...
  async (data, _, user) => {
    ...
    await logActivity(teamId, user.id, ActivityType.DELETE_ACCOUNT);
    // Soft delete
...
export const removeTeamMember = validatedActionWithUser(
  ...
  async (data, _, user) => {
    ...
    await logActivity(user.teamId, user.id, ActivityType.REMOVE_TEAM_MEMBER);
...
export const inviteTeamMember = validatedActionWithUser(
  ...
  async (data, _, user) => {
    ...
    await logActivity(user.teamId, user.id, ActivityType.INVITE_TEAM_MEMBER);
